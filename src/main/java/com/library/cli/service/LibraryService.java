package com.library.cli.service;

import java.time.LocalDate;
import java.util.List;

import com.library.cli.model.Book;
import com.library.cli.model.Member;
import com.library.cli.model.Transaction;
...
public class LibraryService {
    ...
    public boolean returnBook(String bookId) {
        ...
        if (book.getStatus().equals("Issued")) {
            ...
            System.out.println("Error: Book '" + book.getTitle() + "' is not currently Issued (Status: "
                    + book.getStatus() + ").");
            return false;
        }
    }
